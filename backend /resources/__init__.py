...
from .salaries import SalariesResource, SalaryPaymentsResource
...
api.add_resource(CarExpensesResource, '/car-expenses')  # Note: Fix typo if needed ('car-expenses' vs 'car-expenses')

# ----------- SALARIES -----------
api.add_resource(SalariesResource, '/salaries')
api.add_resource(SalaryPaymentsResource, '/salary-payments')
